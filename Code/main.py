...
def instructions():
    ...
    while loop:
        ...
        draw_text('• You are given 10 points initially.',20,colors['light blue'],screen,215,114,True, 'Game Font.ttf')
        draw_text('• There are 4 destinations that Dino must visit (i.e 4 riddles).',20,colors['light blue'],screen,348,145,True, 'Game Font.ttf')
        ...
        draw_text('• Solve each riddle correctly to know where to go next.',20,colors['light blue'],screen,317,204,True, 'Game Font.ttf')
        draw_text('• Use the up,down,left,right keys in order to move Dino in the respective directions.',20,colors['light blue'],screen,456,234,True, 'Game Font.ttf')
        draw_text('• Once Dino meets his friend without being caught, you win.',20,colors['light blue'],screen,335,264,True, 'Game Font.ttf')
        draw_text('• If Dino is caught by a security guard, you lose.',20,colors['light blue'],screen,284,294,True, 'Game Font.ttf')
        draw_text('Rules',40,colors['purple'], screen, WIDTH//2, 350, True, 'Game Font.ttf')
        draw_text('• You will be timed! Solve riddles as quickly as possible.',20,colors['light blue'],screen,323,390,True, 'Game Font.ttf')
        draw_text('• If time runs out while solving a riddle, a guard will automatically catch Dino.',20,colors['light blue'],screen,434,420,True, 'Game Font.ttf')
        draw_text('• There will be a deduction of 5 points for every riddle incorrectly answered and if you go to the',20,colors['light blue'],screen,524,450,True, 'Game Font.ttf')
        draw_text('wrong destination aswell. If your points run out, it is game over.',20,colors['light blue'],screen,378,480,True, 'Game Font.ttf')
...
def story():
    ...
    while loop: 
        ...
        draw_text('Lost in his thoughts, he loses track of where he is and',20,colors['white'],screen,745,144,True, 'Game Font.ttf')
        draw_text('ends up entering Habib University.',20,colors['white'],screen,200,170,True, 'Game Font.ttf')
        draw_text('He has entered HU accidentally and has realised that security has',20,colors['white'],screen,695,170,True, 'Game Font.ttf')
        draw_text('spotted him and is now after him. Dino is worried because he is unaware of ',20,colors['white'],screen,395,197,True, 'Game Font.ttf')
        draw_text('what the security might do.',20,colors['white'],screen,880,197,True, 'Game Font.ttf')
        draw_text('Luckily, Dino knows a student in HU and he is sure that his friend will help him escape!',20,colors['white'],screen,447,223,True, 'Game Font.ttf')
        draw_text('However,',20,colors['white'],screen,905,223,True, 'Game Font.ttf')
        draw_text('he doesn’t know where to go.',20,colors['white'],screen,172,247,True, 'Game Font.ttf')
        draw_text('You are to help Dino find his friend!',25,colors['light red'],screen,515,280,True, 'Game Font.ttf')
        draw_text('It is your responsibility to navigate Dino and make sure he is not caught by security guard that is',20,colors['white'],screen,513,313,True, 'Game Font.ttf')
        draw_text('after him. In order to help, you will be given riddles based on the HU campus.',20,colors['white'],screen,407,340,True, 'Game Font.ttf')
        draw_text('The solution of each',20,colors['white'],screen,876,340,True, 'Game Font.ttf')
        draw_text('riddle is the destination',20,colors['white'],screen,163,367,True, 'Game Font.ttf')
        draw_text('you must go to where you will be given another riddle.',20,colors['white'],screen,545,367,True, 'Game Font.ttf')
        draw_text('These riddles will',20,colors['white'],screen,890,367,True, 'Game Font.ttf')
        draw_text('lead Dino to his friend who will tell him',20,colors['white'],screen,228,392,True, 'Game Font.ttf')
        draw_text('where the exit is. Make sure Dino is not caught by the',20,colors['white'],screen,680,392,True, 'Game Font.ttf')
        draw_text('security!',20,colors['white'],screen,83,416,True, 'Game Font.ttf')
